...
theta.unclear <- matrix(c(0.22, 0.22, 0.22, 0.08, 0.08, 0.09, 0.09,
                          0.10, 0.10, 0.10, 0.25, 0.25, 0.10, 0.10,
                          0.12, 0.12, 0.12, 0.12, 0.12, 0.28, 0.12), byrow = TRUE, nrow = m)
...
st_emiss_distr <-  matrix(c(0.30, 0.30, 0.30, 0.02, 0.02, 0.03, 0.03,
                            0.04, 0.04, 0.04, 0.40, 0.40, 0.04, 0.04,
                            0.09, 0.09, 0.08, 0.08, 0.08, 0.50, 0.08), byrow = TRUE, nrow = m)
