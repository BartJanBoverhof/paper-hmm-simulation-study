...
theta.unclear <- matrix(c(0.25, 0.10, 0.10, 0.10, 0.10, 0.25, 0.10,
...
for(sim_i in 1:n_sim){
  data1[[sim_i]] <- sim_mHMM(n_t = n_t, n = n, m = m, q_emiss = q_emiss,
                             gamma = gamma, emiss_distr = theta.unclear) 
}
...
st_emiss_distr <- matrix(c(0.40, 0.04, 0.04, 0.04, 0.04, 0.40, 0.04,
