...
theta.unclear <- matrix(c(0.40, 0.10, 0.10, 0.10, 0.10, 0.10, 0.10,
                          0.10, 0.25, 0.10, 0.25, 0.10, 0.10, 0.10,
                          0.08, 0.08, 0.22, 0.09, 0.22, 0.09, 0.22), byrow = TRUE, nrow = m)
...
for(sim_i in 1:n_sim){
  data1[[sim_i]] <- sim_mHMM(n_t = n_t, n = n, m = m, q_emiss = q_emiss,
                             gamma = gamma, emiss_distr = list(theta.unclear)) 
}
...
st_emiss_distr <- matrix(c(0.60, 0.06, 0.06, 0.07, 0.07, 0.07, 0.07,
                           0.04, 0.40, 0.04, 0.40, 0.04, 0.04, 0.04,
                           0.04, 0.04, 0.28, 0.04, 0.28, 0.04, 0.28), byrow = TRUE, nrow = m)
