...
theta.7obs <- matrix(c(0.88, 0.02, 0.02, 0.02, 0.02, 0.02, 0.02,
                       0.02, 0.45, 0.45, 0.02, 0.02, 0.02, 0.02,
                       0.02, 0.02, 0.02, 0.31, 0.30, 0.31, 0.02), byrow = TRUE, nrow = m)
...
st_emiss_distr <-  matrix(c(0.70, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05,
                            0.05, 0.40, 0.35, 0.05, 0.05, 0.05, 0.05,
                            0.04, 0.03, 0.03, 0.29, 0.29, 0.29, 0.03), byrow = TRUE, nrow = m)
